...
- Команде React за прекрасную библиотеку
- Сообществу TypeScript
- GitHub за бесплатный хостинг
- Всем, кто вносил вклад в развитие проекта

## 📞 Контакты

**Ваше Имя** - @dashahass

Ссылка на проект: https://github.com/dashahass/employee-monitoring-mvp
